let ChatPagina = function () {
    ...
    let downloadChatrooms = function () {
        if( Netwerk.status() !== 'No network connection' ) {
            let url = "https://robbeh.sinners.be/meventer/download_chatrooms.php";
    ...
    let laadPagina = function (vriendid, naam) {
        ...
        let url = "https://robbeh.sinners.be/meventer/krijg_chatroomid.php";
    ...
    let toonOudereBerichten = function (requestVan) {
        ...
        console.log(timestampEersteBericht);
        let url = "https://robbeh.sinners.be/meventer/krijg_oudere_berichten_bij_kamerid.php";
    ...
    let checkVoorBerichten = function () {
        if( kamerid !== 0 && vriendid !== 0 ) {
            ...
            let url = "https://robbeh.sinners.be/meventer/krijg_berichten_van_kamerid.php";
    ...
    $('#cp-stuur-bericht').click(function () {
        if( Netwerk.status() !== 'No network connection' ) {
            ...
            let url = "https://robbeh.sinners.be/meventer/stuur_bericht.php";
